...
namespace Transmitly.ChannelProvider.Infobip.Api.Voice
{
	public sealed class VoiceExtendedChannelProperties : IVoiceExtendedChannelProperties
	{
		...
		internal VoiceExtendedChannelProperties(IVoiceChannelConfiguration voiceChannel)
		{
			Guard.AgainstNull(voiceChannel);
			_extendedProperties = Guard.AgainstNull(voiceChannel.ExtendedProperties);
		}
		internal VoiceExtendedChannelProperties(IExtendedProperties properties)
		{
			_extendedProperties = Guard.AgainstNull(properties);
		}
		public VoiceExtendedChannelProperties()
		{
		...
		{
			get => _extendedProperties.GetValue(ProviderKey, nameof(MachineDetection), MachineDetection.Enabled);
